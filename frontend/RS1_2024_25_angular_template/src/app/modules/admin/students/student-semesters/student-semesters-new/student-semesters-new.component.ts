...
import {AcademicYearResponse} from '../../../../../DTOs/AcademicYearResponse';
  ...
  newSemester()
  {
    if(this.form.valid)
    {
      let req = {
        ...
        akademskaGodinaId: this.form.get('akademskaGodinaId0')!.value,
      ...
      this.http.post<number>(`${MyConfig.api_address}/yos/create`,req).subscribe({
        ...
        error: err => {
          this.snackbar.showMessage("Error while creating");
        }
      })
    }
  }
